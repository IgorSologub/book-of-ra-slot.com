...
public class BasePage {
    ...
    private final By headerMenuOpen = By.xpath("//button[@class='c-header__hamburger-btn js-header-modal-btn']");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='c-header__menu-link '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='c-header__menu-link '])[2]");
